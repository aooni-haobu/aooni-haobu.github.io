//=============================================================================
// AooniLib.js (for Limited Version)
//=============================================================================

/*:
 * @plugindesc Library for Aooni MV(for Limited Version)
...
(function() {
  ...
  //
  // for beginners of Aooni, slow mode available.
  //
...
//  };
  ...
  Game_Event.prototype.setImage = function(characterName, characterIndex) {
    if (characterName === '!$ao') {
      if ($gameSwitches.value(76)) { // comical mode
